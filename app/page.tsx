...
export async function generateMetadata() {
  ...
  // 英文主页的描述
  const description = 'zoxide is a smarter cd command for instant directory navigation. Get installation guides for Ubuntu, macOS, Windows, and tutorials for fzf and Neovim integration.';
